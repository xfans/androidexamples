 ...
 * because {@link com.examples.demo.ex16.androidsvg.SVG SVG}/{@link android.graphics.Picture Picture}
...
public class SvgSoftwareLayerSetter<T> implements RequestListener<T, PictureDrawable> {
    SVGTestActivity.SVGListener listener;

    public SvgSoftwareLayerSetter(SVGTestActivity.SVGListener listener) {
